package com.lyn.modules.business.controller;

import com.lyn.modules.business.entity.Business;
import com.lyn.modules.business.service.MenuService;
...
public class MenuController {
    ...
    public Result getAllMenu() {
        ...
        List<Business> businesses = menuService.getAllMenu();
        result.setCode(STATUS.SUCCESS);
        result.setData(businesses);
        return result;
    }
    ...
    public Result getNodeMenu(@PathVariable("id") long id) {
        Result result = new Result();
        List<Business> businesses = menuService.getMenu(id);
        result.setCode(STATUS.SUCCESS);
        result.setData(businesses);
        return result;
    }
     ...
     */
    @PostMapping("/save")
    public Result updateMenu(@RequestBody Business business) {
        Result result = new Result();
        result.setData(menuService.saveMenu(business));
        result.setCode(STATUS.SUCCESS);
        return result;
    }
